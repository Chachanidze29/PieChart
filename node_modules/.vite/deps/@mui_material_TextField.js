import {
  Paper_default,
  createSvgIcon
} from "./chunk-4LTQRIKP.js";
import {
  Transition_default,
  useForkRef_default
} from "./chunk-GRUJRGB7.js";
import {
  Popper,
  Portal,
  areArraysEqual,
...
function useTransitionTrigger(requestEnter) {
  const [state, dispatch] = React40.useReducer(transitionStateReducer, {
    elementExited: !requestEnter,
    inProgress: false
  });
  const hasTransition = React40.useRef(false);
  const handleEntering = React40.useCallback(() => {
    dispatch("entering");
  }, []);
  const handleEntered = React40.useCallback(() => {
    dispatch("entered");
  }, []);
  const handleExiting = React40.useCallback(() => {
    dispatch("exiting");
  }, []);
...
var NativeSelectInput = React90.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime68.jsxs)(React90.Fragment, {
...
var Select3 = React93.forwardRef(function Select4(inProps, ref) {
  ...
  return (0, import_jsx_runtime72.jsx)(React93.Fragment, {
